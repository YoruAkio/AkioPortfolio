    ...
    <section id="about" className="py-20 bg-secondary/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-3xl lg:text-4xl font-semibold text-foreground mb-8">
              My Journey
            </h3>
            <p className="text-foreground/80 mb-6 text-lg lg:text-xl leading-relaxed">
            ...
            <p className="text-foreground/80 mb-8 text-lg lg:text-xl leading-relaxed">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-4 py-2 bg-primary/10 text-primary rounded-full text-base lg:text-lg">
                Always Learning
              </span>
              <span className="px-4 py-2 bg-primary/10 text-primary rounded-full text-base lg:text-lg">
                Self-Taught
